<template>
  ...
  <header class="bg-white shadow-sm">
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <h1 class="text-3xl font-bold tracking-tight text-gray-900">Edit your Income</h1>
    </div>
  </header>

  <form @submit.prevent="updateIncome" class="max-w-md mx-auto mt-12">
...
const updateIncome = () => {
  form.put(route('updateIncome', props.income.id), {
    onSuccess: () => {
